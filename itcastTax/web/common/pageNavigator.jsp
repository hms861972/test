        ...
        <table width="100%" class="pageDown" border="0" cellspacing="0"
            ...
            <tr>
                <td align="right">
                    ...
                    到&nbsp;<input id="pageNo" name="pageNo" type="text" style="width: 30px;" onkeypress="if(event.keyCode == 13){doGoPage(this.value);}" min="1" value="<s:property value='pageResult.pageNo'/>" /> &nbsp;&nbsp;
                </td>
            </tr>
        </table>
    </s:if>
