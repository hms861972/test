...
<head>
    ...
    function doAdd() {
        document.forms[0].action="${pageContext.request.contextPath}/nsfw/role_addUI.action";
    ...
    function doEdit(id) {
        document.forms[0].action = "${pageContext.request.contextPath}/nsfw/role_editUI.action?role.roleId=" + id;
        document.forms[0].submit();
    }
