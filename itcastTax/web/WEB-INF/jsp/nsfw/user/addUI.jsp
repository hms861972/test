...
<form id="form" name="form" action="${pageContext.request.contextPath}/nsfw/user_add.action" method="post" enctype="multipart/form-data" onsubmit="return doVerifySubmit()">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            onfocus="WdatePicker({skin:'whyGreen', el:'birthday',dateFmt:'yyyy-MM-dd'})"/></td>
        </tr>
		<tr>
